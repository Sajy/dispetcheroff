...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:LoginView ID="LoginView1" runat="server">
            <AnonymousTemplate>
                <!-- #include file="content/jambo.aspx" -->
            </AnonymousTemplate>
            <LoggedInTemplate>
                            ...
                            <div class="panel-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>На вашем счету:  <% Response.Write("<span class='badge'>" + Convert.ToString(Profile.Money) + " грн.</span>");%>
                                            ...
                                            <form role="form88" id="payment" name="payment" method="post" enctype="utf-8">
                                                ...
                                                <button type="submit" class="btn btn-default btn-sm" formaction="https://sci.interkassa.com/">Пополнить?</button>
                                            </form>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <th><a href="Offers.aspx">МОИ ОБЪЯВЛЕНИЯ НА ПРОДАЖУ</a></th>
                                        <th><a href="Bids.aspx">МОИ ОБЪЯВЛЕНИЯ НА ПОКУПКУ</a></th>
                                        <th><a href="Transport.aspx">МОИ ПРЕДЛОЖЕНИЯ ДЛЯ ТРАСПОРТА</a></th>
                                        <th><a href="ActiveContracts.aspx">АКТИВНЫЕ КОНТРАКТЫ</a></th>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#">Получать заказы на транспорт</a></td>
                                        <td>30 грн./мес  </td>
                                        <td class="text-center"><i class="glyphicon glyphicon-remove"></i></td>
                                        <td class="text-center">
...
<%--        <!--Диалог активации-->
        ...
        <!--Начало табов-->
        <!--Конец табов-->
        <!-- #include file="content/navtabs.aspx" -->
        <!-- #include file="content/footer.aspx" -->
    </form>
    <!-- #include file="content/bottomincludes.aspx" -->
    <script>        jQuery(function ($) {

            $("#telephone").mask("(999) 99-99-99");
            $("#TextBox1").mask("99-99-99-99");
        });</script>
